...
<div class="conts-box">
    ...
    <!-- form -->
    <form name="excelUploadForm" id="excelUploadForm" method="post" action="/purchaseUploadBreakdownRegProc" enctype="multipart/form-data" autocomplete="off">
        <!-- searchArea -->
        <article class="searchArea">
            <div class="inputArea upload">
                ...
                <!-- inputBox -->
                <div class="fileArea">
                    <label for="inputUpload" class="btn search">매입 업로드</label>
...
<script>
    ...
    // 작성년월 선택안하고 업로드 버튼을 누르면 경고창을 띄운다.
