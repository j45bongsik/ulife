...
<div class="conts-box">
    ...
    <!-- form -->
    <form name="searchForm" id="searchForm" method="get" action="/insuranceCompanyBreakdown">
        <!-- searchArea -->
        <article class="searchArea">
            ...
            <div class="inputArea">
                ...
                <div class="select-custom">
                    <select name="insuranceCompanyCategory" id="insuranceCompanyCategory">
                        <?=$INSURANCECOMPANYCATEGORYLISTOPTION?>
                    </select>
                </div>
                <!-- //select-custom -->
                <div class="select-custom">
                ...
                <label for="business_name">
                    <input type="text" name="account" id="account" placeholder="거래처명" autocomplete='off' value="<?=$ACCOUNT?>">
                </label>
            ...
            <!-- btnArea -->
            <div class="btnArea">
                <a <?=$INSURANCECOMPANYBREAKDOWNLISTEXCEL?> class="btn file">엑셀다운</a>
            </div>
            <!-- //btnArea -->
        </article>
        <!-- //searchArea -->
    ...
    <article class="memb-table erpList">
        <table>
            <caption>
                마감 내역 테이블로 순번, 청약일, 보험사, 거래처, 상품명, 채널, 구분, 체류기간, 수수료율, 보험료, 수수료, 커미션, 수익 등의 정보를 제공합니다.
            </caption>
            <colgroup>
        ...
        <div class="sumArea">
            <ul>
                ...
                <li>
                    <p class="totalAmount"><?=$INSURANCECOMPANYBREAKDOWNTOTALSUM?></p>
                </li>
            </ul>
        </div>
    </article>
